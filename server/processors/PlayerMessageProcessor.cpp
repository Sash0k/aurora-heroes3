...
bool PlayerMessageProcessor::handleCheatCode(const std::string & cheatFullCommand, PlayerColor player, ObjectInstanceID currObj)
{
	std::string cheat = boost::trim_copy(cheatFullCommand);
	std::vector<std::string> words;
